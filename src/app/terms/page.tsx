    ...
    <div className="min-h-screen bg-white text-black selection:bg-[#00ea77]/30">
      ...
      <main className="max-w-4xl mx-auto px-6 py-32 md:py-48">
        ...
        <div className="space-y-8 text-black/65 leading-relaxed font-light">
          ...
          <section>
            <h2 className="text-2xl text-black mb-4">2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-2xl text-black mb-4">3. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-2xl text-black mb-4">4. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-2xl text-black mb-4">5. Contact Information</h2>
